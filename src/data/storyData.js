...
export const storyData = {
  ...
  ch1_intro: {
    ...
    narration:
      "Năm 2024, giữa lòng thành phố Hồ Chí Minh nhộn nhịp, Hưng — một chàng trai 28 tuổi đầy nhiệt huyết — quyết định mở một xưởng sản xuất giày da thủ công. Với số vốn khiêm tốn từ gia đình và niềm đam mê với nghề truyền thống, anh tin rằng chất lượng sản phẩm sẽ tạo nên sự khác biệt.",
  ...
  ch1_problem: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Chỉ sau ba tháng, Hưng nhận ra thực tế phũ phàng: các đối thủ cạnh tranh bán giày với giá rẻ hơn 40%. Những đôi giày sản xuất hàng loạt từ các nhà máy lớn tràn ngập thị trường. Đơn hàng của Hưng giảm dần. Anh đứng trước ngã rẽ quan trọng nhất trong sự nghiệp...",
  ...
  ch1_machine: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hưng quyết định vay ngân hàng để đầu tư dây chuyền sản xuất hiện đại. Chỉ sau hai tháng, năng suất tăng gấp ba lần. Giá thành mỗi đôi giày giảm đáng kể. Sản phẩm của Hưng giờ đây có thể cạnh tranh trực tiếp với các đối thủ lớn trên thị trường. Quyết định này đã thay đổi hoàn toàn cục diện...",
  ...
  ch1_manual: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hưng quyết định giữ vững phương pháp sản xuất thủ công. Anh tập trung nâng cao tay nghề thợ, chọn nguyên liệu tốt nhất, và xây dựng thương hiệu giày cao cấp. Tuy không thể cạnh tranh về giá, nhưng sản phẩm của Hưng được đánh giá cao về chất lượng. Con đường này đòi hỏi kiên nhẫn và niềm tin...",
  ...
  ch1_convergence: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Dù chọn con đường nào, Hưng đều nhận ra một điều: trong nền kinh tế thị trường, mọi quyết định sản xuất đều phải tuân theo quy luật giá trị. Giá cả xoay quanh giá trị, và người sản xuất phải không ngừng nâng cao hiệu quả. Xưởng giày của Hưng đã vượt qua giai đoạn khó khăn đầu tiên. Nhưng thử thách lớn hơn đang chờ phía trước...",
  ...
  ch2_intro: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hai năm sau, công ty của Hưng đã phát triển đáng kể. Từ một xưởng nhỏ, giờ đây anh có 50 công nhân và doanh thu ổn định. Nhưng áp lực từ nhà đầu tư ngày càng lớn — họ muốn lợi nhuận cao hơn. Hưng phải tìm cách tăng giá trị thặng dư, nhưng bằng cách nào?",
  ...
  ch2_hours: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Chính sách tăng ca được áp dụng. Lúc đầu, doanh thu tăng rõ rệt. Nhưng chỉ sau vài tháng, hậu quả bắt đầu xuất hiện: công nhân mệt mỏi, tai nạn lao động gia tăng, chất lượng sản phẩm giảm sút. Một số thợ lành nghề xin nghỉ việc. Hưng nhận ra rằng kéo dài thời gian lao động không phải là giải pháp bền vững...",
  ...
  ch2_tech: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hưng quyết định đầu tư vào dây chuyền sản xuất thông Hưng. Công nhân được đào tạo sử dụng công nghệ mới. Năng suất lao động tăng 60% mà thời gian làm việc không đổi. Chi phí đầu tư ban đầu cao, nhưng chỉ sau sáu tháng, hiệu quả kinh tế đã vượt xa kỳ vọng. Công nhân hài lòng vì được nâng cao tay nghề...",
  ...
  ch2_convergence: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Qua thử thách này, Hưng hiểu sâu hơn về bản chất của giá trị thặng dư — nguồn gốc của lợi nhuận. Dù chọn tăng thời gian hay cải tiến công nghệ, cả hai đều là cách tạo ra giá trị thặng dư. Nhưng phương pháp nào mang lại phát triển bền vững? Câu trả lời sẽ định hình tương lai của doanh nghiệp. Và một cuộc cách mạng công nghệ lớn đang đến...",
    backgroundTheme: "reflection",
    choices: null,
    insight: null,
    nextScene: "ch3_intro",
  ...
  ch3_problem: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Ban giám đốc họp khẩn cấp. Số liệu cho thấy nếu triển khai AI toàn diện, chi phí sản xuất giảm 50% nhưng 140 công nhân sẽ mất việc. Đây không chỉ là quyết định kinh tế — đây là quyết định về con người, về trách nhiệm xã hội. Hưng nhìn xuống danh sách nhân viên, những người đã gắn bó từ ngày đầu...",
  ...
  ch3_cut: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hệ thống AI được triển khai nhanh chóng. 140 công nhân nhận thông báo nghỉ việc. Nhà máy vận hành hiệu quả chưa từng có. Nhưng bên ngoài cổng nhà máy, những người mất việc đối mặt với tương lai bất định. Truyền thông đưa tin, dư luận xôn xao. Hưng nhận ra rằng lợi nhuận không thể đo bằng những con số lạnh lùng...",
  ...
  ch3_retrain: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Hưng chọn con đường khó hơn nhưng đúng đắn hơn. Anh thành lập trung tâm đào tạo nội bộ, giúp công nhân học kỹ năng số, vận hành và bảo trì hệ thống AI. Không ai bị bỏ lại phía sau. Sau một năm, công ty không chỉ tăng trưởng mà còn trở thành hình mẫu cho phát triển bền vững. Câu chuyện của Hưng được đưa lên báo chí như một tấm gương kinh doanh có trách nhiệm...",
  ...
  ch3_convergence: {
    ...
    narrator: "Người dẫn chuyện",
    narration:
      "Từ một xưởng giày nhỏ, hành trình của Hưng đã đi qua ba chương lớn của kinh tế chính trị: từ hiểu bản chất hàng hóa và giá trị, đến nắm bắt quy luật giá trị thặng dư, và cuối cùng là nhận thức về phát triển bền vững.\n\nMỗi quyết định kinh tế đều tạo nên dòng chảy — dòng chảy của giá trị, của lao động, của những mối quan hệ giữa con người với con người trong quá trình sản xuất. Và dòng chảy ấy sẽ tiếp tục...",
